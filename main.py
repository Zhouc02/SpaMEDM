...
if __name__ == "__main__":
    ...
    parser.add_argument('--tool', type=str, default='svd', choices=['svd', 'mclust', 'leiden', 'louvain', 'kmeans'], help='tool for clustering')
    ...
    parser.add_argument('--weight3', type=float, default=1, help='weight3')
